...
const EXPECTED_ACCESS: Record<string, Permission | 'public'> = {
  ...
  'PATCH /api/customers/:customerId': 'customer.update',
  'POST /api/customers/:customerId/line-transfer': 'customer.changeLine',
  'GET /api/customers/:customerId/line-transfers': 'customer.view',
  'GET /api/customers/:customerId/overview': 'customer.view',
  'GET /api/customers/:customerId/collections': 'collection.view',
