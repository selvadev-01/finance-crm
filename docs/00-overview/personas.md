...
- Every saved collection needs an unmistakable visual confirmation, and an honest sync state — _saved on device_ is different from _synced to office_ and the Junior must be able to tell which.
