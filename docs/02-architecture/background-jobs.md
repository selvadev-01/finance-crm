...
**No business logic in handlers.** A handler resolves its inputs and calls the owning module's service. The job layer decides _when and how reliably_, never _what_.
