...
| Session                 | 7 days, rolling, with "Keep me signed in" (default); browser-session and 1 day without; 30 days absolute from sign-in either way. `httpOnly` + `secure` + `sameSite: lax`                                        |
